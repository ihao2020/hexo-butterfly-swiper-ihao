...
// =====================================================================
  ...
  const tag = config.tag ? config.tag : [{"name": "必看精选","path": "/tags/必看/","shadow":"var(--ihao-shadow-blue)"},{"name": "热门文章","path": "/tags/热门/","shadow":"var(--ihao-shadow-red)"},{"name": "实用教程","path": "/tags/教程/","shadow":"var(--ihao-shadow-green)"}]
  // 如果配置开启
  ...
  // 集体声明配置项
    const data = {
      ...
      top_group_list: top_group_list,
      default_descr: config.default_descr ? config.default_descr : "再怎么看我也不知道怎么描述它的啦！",
      swiper_css: config.swiper_css ? urlFor(config.swiper_css) : "https://cdn.cbd.int/hexo-butterfly-swiper-ihao/lib/swiper.min.css",
      swiper_js: config.swiper_js ? urlFor(config.swiper_js) : "https://cdn.cbd.int/hexo-butterfly-swiper-ihao/lib/swiper.min.js",
      custom_css: config.custom_css ? urlFor(config.custom_css) : "https://cdn.cbd.int/hexo-butterfly-swiper-ihao/lib/swiperstyle.css",
      custom_js: config.custom_js ? urlFor(config.custom_js) : "https://cdn.cbd.int/hexo-butterfly-swiper-ihao/lib/swiper_init.js",
      gsap_js: config.gsap_js ? urlFor(config.gsap_js) : "https://cdn.cbd.int/cdn/expire-1-M/gsap/3.9.1/gsap.min.js",
      people_js: config.people_js ? urlFor(config.people_js) : "https://cdn.cbd.int/hexo-butterfly-swiper-ihao/lib/people.js",
      tag: tag,
      taggroup_css: config.taggroup_css ? urlFor(config.taggroup_css) : "https://cdn.cbd.int/hexo-butterfly-swiper-ihaoo/lib/tagGroup.css",
    }
  // 渲染页面
  ...
  //cdn资源声明
    //样式资源
  const css_text = `<link rel="stylesheet" href="${data.swiper_css}" media="print" onload="this.media='all'"><link rel="stylesheet" href="${data.custom_css}" media="print" onload="this.media='all'"><link rel="stylesheet" href="${data.taggroup_css}" media="print" onload="this.media='all'">`
    //脚本资源
  ...
  if (data.randomenable) {
    js_text += `<script defer src="${data.people_js}"></script><script async src="/ihao/random.js"></script>`
  }
...
hexo.extend.generator.register('random', function (locals) {
  ...
  return {
    path: config.path || 'ihao/random.js',
